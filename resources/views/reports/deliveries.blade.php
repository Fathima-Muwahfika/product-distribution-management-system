...
<div class="card mb-3 no-print">
    <div class="card-body py-3">
        <form method="GET" class="row g-2 align-items-end">
            <div class="col-md-3">
                <label class="form-label" style="font-size:11px;font-weight:600;">FILTER BY STATUS</label>
            ...
            <div class="col-md-4 d-flex gap-2">
                ...
                <a href="{{ route('reports.deliveries') }}" class="btn btn-secondary btn-sm">Reset</a>
    ...
    <div class="card-body p-4">
        ...
        <div class="report-header">
            ...
            <div class="report-header-right">
                ...
                @if(request('status'))
                <div class="report-meta">Status Filter: {{ request('status') }}</div>
                @endif
                <div class="report-meta">Total: {{ $totalDeliveries }} | Delivered: {{ $delivered }} | Pending: {{ $pending }}</div>
            </div>
        </div>
        ...
        <div class="report-summary">
            ...
            <div class="summary-item">
                <div class="summary-value text-success">{{ $delivered }}</div>
                <div class="summary-label">Delivered</div>
            </div>
            <div class="summary-item">
                <div class="summary-value text-info">{{ $outForDelivery }}</div>
                <div class="summary-label">Out for Delivery</div>
            </div>
            <div class="summary-item">
                <div class="summary-value text-warning">{{ $pending }}</div>
        ...
        <table class="report-table">
            ...
            <tbody>
                ...
                @empty
                <tr>
                    <td colspan="6" style="text-align:center;padding:20px;color:#94a3b8;">No deliveries found.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
